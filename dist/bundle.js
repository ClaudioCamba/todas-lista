...
class Task {
    ...
    buildElem() {
        ...
        this.dueDateElem.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(this.dueDate), 'dd/MM/yyyy');
